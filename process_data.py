...
for entry in manifest_data:
    ...
    vid = path_obj.stem # "v0014"
    
    # CHECK: Does the ID exist in the bank?
    ...
    # Load the voice (Tensor OR String - both are accepted now)
    ...
    # KEY FIX: Use the raw value directly. 
    # Whether it is a Tensor or a String code, ChatTTS.infer() handles it.
